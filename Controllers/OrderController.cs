...
namespace SHOPAPI.Controllers
{
    public class OrderController : ApiController
    {
        ...
        {
            _emailService = new EmailService(); // Hoặc inject qua DI container
        }
        ...
        {
            var orders = db.Orders.Select(o => new OrderReadDto
            {
                Id = o.Id,
                Name = o.Name,
                PhoneNumber = o.PhoneNumber,
                Email = o.Email, // Thêm Email
                Address = o.Address,
                Note = o.Note,
                ...
                try
                {
                    ...
                    foreach (var itemDto in dto.Items)
                    {
                        ...
                        var orderItem = new OrderItem
                        {
                            ...
                            Product = product // Để có thể access Product trong email
                        };
                    ...
                    {
                        // Log lỗi email nhưng vẫn trả về success cho order
